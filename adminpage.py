...
inner_frame = ctk.CTkFrame(root, bg_color='#7E9779', fg_color='#262724', corner_radius=60, width=600, height=500)
...
but_exit = ctk.CTkButton(inner_frame, corner_radius=20, text='Log out', text_color='#262724', fg_color='#7B9976',
                         hover_color='#7B9976', font=('Times New Roman', 30, 'bold'), image=exiticon,
                         command=exitt)
...
but_Cancel_Event = ctk.CTkButton(inner_frame, corner_radius=20, text_color='#262724', fg_color='#7B9976',
                                 hover_color='#7B9976', text='Edit Events', font=('Times New Roman', 30, 'bold'),
...
but_create = ctk.CTkButton(inner_frame, corner_radius=20, text_color='#262724', fg_color='#7B9976',
                           hover_color='#7B9976', text='Create Event', font=('Times New Roman', 30, 'bold'), width=70,
...
but_back = ctk.CTkButton(inner_frame, text='', fg_color='#262724', hover='#262724', image=back_image, width=40,
                         hover_color='#7B9B75', command=settingsbutton)
