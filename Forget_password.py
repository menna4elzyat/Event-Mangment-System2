...
def check_security_question():
    ...
    if user:
        ...
        messagebox.showwarning("Error","Invaild username or Incorrect Mother name")
...
label_photo.pack()
forgotPasswordFrame = ctk.CTkFrame(root, corner_radius=60, width=700, height=500, fg_color="#262624",
                                   bg_color='#7B9976')
...
but_back = ctk.CTkButton(forgotPasswordFrame, text='', hover='#262724', fg_color='#262724', image=back_image, width=40,
                         hover_color='#7B9B75', command=back)
but_back.place(x=20, y=40)
