...
label_photo.pack()
inner_frame = ctk.CTkFrame(root, corner_radius=60, width=600, height=500, bg_color='#7E9779', fg_color='#262724')
...
but_exit = ctk.CTkButton(inner_frame, corner_radius=20, text='Log out', text_color='#262724', fg_color='#7B9976',
                         hover_color='#7E9779', command=logout,
...
bookinButton = ctk.CTkButton(inner_frame, corner_radius=20, image=bookingImage, text='Booking ticket',
                             text_color='#262724', hover_color='#7E9779', fg_color='#7E9779',
...
cancelButton = ctk.CTkButton(inner_frame, corner_radius=20, image=cancelTicketImage, text='cancel ticket',
                             fg_color='#7E9779', hover_color='#7E9779', text_color='#262724',
                             font=('Times New Roman', 30, 'bold',), width=45).place(x=200, y=322)
viewButton = ctk.CTkButton(inner_frame, corner_radius=20, image=viewTicketimage, text='view tickets',
                           fg_color='#7E9779', hover_color='#7E9779', text_color='#262724',
                           font=('Times New Roman', 30, 'bold'), width=45).place(x=200, y=235)
back_image = ImageTk.PhotoImage(file='assests/gear.png')
but_back = ctk.CTkButton(inner_frame, text='', fg_color='#262724', hover='#262724', image=back_image, width=40,
                         command=settings,
                         hover_color='#7B9B75')
